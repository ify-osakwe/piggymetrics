...
public class CustomUserInfoOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public OAuth2AuthenticatedPrincipal introspect(String token) {
        ...
        // Attach raw attributes; Security will turn this into a BearerTokenAuthentication
    ...
    private Collection<GrantedAuthority> extractAuthorities(Map<String, Object> map) {
        // 1) If provider already returns authorities/roles:
        ...
        // 2) Fall back to OAuth2 scopes -> "SCOPE_x" authorities
...
class SecurityConfig {
    ...
    OpaqueTokenIntrospector introspector() {
        // Use your previous userInfoEndpointUrl here:
        return new CustomUserInfoOpaqueTokenIntrospector("https://auth.example.com/userinfo");
    }
